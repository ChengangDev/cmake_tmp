...
// configuration step. It creates a namespace called `cmake_tmp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_tmp::cmake::project_name, cmake_tmp::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_tmp::cmake::project_version);
      return EXIT_SUCCESS;
    }
